...
export const episodes: Episode[] = [
  ...
  // September 6, 2026 Episode — do not surrender your mind
  {
    id: "46",
    episode_number: 46,
    title: "Blessed Love Voice of Africa Show - September 6, 2026",
    description: "DO NOT SURRENDER YOUR MIND, YOUR HISTORY, OR YOUR POWER. A clear trumpet call: wake up, know yourself, study your history, and prepare for a future built on justice, dignity and self-determination. Rooted in the Ethiopia Africa Black International Congress, the programme moves through the spiritual responsibilities of the prophet, priest and king; the call to place every person under their own vine and fig tree; the Universal Declaration of Human Rights; and the Rastafari commitment to African consciousness, international repatriation and economic liberation. The broadcast revisits the Italian invasion of Ethiopia and gives thanks for Emperor Haile Selassie I's resistance to fascism, connecting that history to today's debates on power, propaganda, war, borders and the unequal application of international law. It challenges the language of 'independence' when systems remain economically dependent, and urges listeners to look beyond nationality toward ancestry, land and collective responsibility. It turns its lens to the reported trafficking of Africans in Libya, the treatment of Haitians in the Caribbean, the struggle for Rastafari rights, and the need for prisons to become places of education and rehabilitation. From the Sahel to Haiti to the wider African world: support food security, build knowledge, defend human rights, reject manipulation, and organise around a righteous future.",
    archive_url: "https://archive.org/download/show-on-9-6-2026-full-show/show%20on%209%206%202026%20%20full%20show.mp3",
    published_date: "2026-09-06"
  },
  // September 13, 2026 Episode — freedom, redemption, repatriation with compensation
  {
    id: "47",
    episode_number: 47,
    title: "Blessed Love Voice of Africa Show - September 13, 2026",
    description: "FREEDOM, REDEMPTION, ECONOMIC LIBERATION AND INTERNATIONAL REPATRIATION WITH COMPENSATION. Opening with prayer, Nyabinghi consciousness and thanksgiving for the Ethiopian New Year, Prophet Alem honours the Prophet, Priest and King order of Rastafari and gives reverence to His Imperial Majesty Emperor Haile Selassie I, King Emmanuel Charles Edwards and the vision of the Right Excellent Marcus Mosiah Garvey. The September 11 remembrance forms a central part of the reasoning: the persecution of Rastafari at Mount Jimmy in Saint Lucia, a tribute to the late Ras Choco, and the wider history of state violence against the community — Coral Gardens in Jamaica, restrictions on sacramental cannabis, and the struggle for religious headdress and equal treatment under the law. The broadcast examines reparations and the British monarchy's acknowledgment of the horrors of slavery without a commitment to compensation, holding that emancipation without economic power remains incomplete. Callers reason on Ethiopian history, the Ethiopian Bible and the King James translation, and the invasion of Ethiopia by Fascist Italy and the importance of Emperor Haile Selassie's resistance. Contemporary geopolitics — Yemen, the Houthis, Saudi Arabia and the strategic Red Sea shipping corridor — enter the reasoning as viewpoints for investigation, not established fact. Throughout, one message holds: political independence without control of land, production, finance, technology and education is only partial freedom. From Saint Lucia and the wider Caribbean to Ethiopia, the Sahel and the African diaspora, the call is for disciplined preparation, unity, youth development, equal rights and justice. Africa for Africans — those at home and those abroad.",
    archive_url: "https://archive.org/download/show-on-9-13-2026-full/show%20on%20%209%2013%202026%20full.mp3",
    published_date: "2026-09-13"
  },
  // September 20, 2026 Episode — Babylon burning / own the tools of development
  {
    id: "48",
    episode_number: 48,
    title: "Blessed Love Voice of Africa Show - September 20, 2026",
    description: "BABYLON BURNING, SPIRITUAL EMANCIPATION, AFRICAN SOVEREIGNTY AND THE STRUGGLE TO OWN THE TOOLS OF DEVELOPMENT. Prophet Alem opened with thanksgiving for life, the Ethiopia Africa Black International Congress, the Church of Divine Salvation, Four Wings Universal and Blazing 99.3 FM. The programme centered the Rastafari understanding of the Prophet, Priest and King \u2014 vision, ceremonial order and leadership for the people \u2014 giving reverence to His Imperial Majesty Emperor Haile Selassie I, King Emmanuel Charles Edwards and the legacy of Marcus Mosiah Garvey, and calling listeners to 'see yourself and know yourself' through African history, spiritual discipline and conscious action. A major thread was the relationship between spirituality and liberation: education, political slogans and material success cannot complete emancipation if the mind remains trapped inside inherited colonial ideas. The broadcast moved into the material world \u2014 the wars and rivalries surrounding Yemen and Saudi Arabia, the wider struggle in the Sahel, and the possibility that global conflict may reshape the political space available to African liberation movements (presented as the programme's reasoning and predictions, not settled forecasts). It introduced four areas for further examination: Dr. Marimba Ani's analysis of how belief systems shape understanding of oppression, identity and collective memory; the rise of 'smart cities,' data collection and surveillance as a possible new form of social control; the contested history of Sudan and the Anyanya conflict (treated as a historical argument to investigate through records and competing sources); and Burkina Faso and the wider African development question \u2014 why African countries can pay more to build less, and whether owning construction machines, factories, roads, processing capacity and technical skills can turn public spending into lasting sovereignty. The central message: liberation must be spiritual, economic, technological and institutional at the same time. Africa cannot remain only the place where raw materials, data, labour and markets are extracted \u2014 the people must own the tools, open the books, train the youth and build productive systems that remain in African hands. Africa for Africans \u2014 those at home and those abroad.",
    archive_url: "https://archive.org/download/show-on-9-20-2026-full-show/show%20on%20%209%20%2020%202026%20FULL%20SHOW.mp3",
